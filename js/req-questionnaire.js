...
class ReqQuestionnaireManager {
    constructor() {
        this.STORAGE_KEY = 'renovation_questionnaire';
            ...
            <div class="rq-wrap">
                <div class="rq-toolbar">
                    <div class="rq-toolbar-left">
                        <h2>装修需求问卷</h2>
                        <p class="rq-desc">世华泊郡 · 88㎡ · 两室两厅一卫 · 1层 · 填写后自动本地保存</p>
                    </div>
    ...
    buildFormHtml() {
        return `
            ...
            <p class="rq-sub">世华泊郡 · 88㎡ · 两室两厅一卫 · 1层</p>
            ...
            <div class="rq-sec">
                ...
                <div class="rq-g"><div class="rq-g-t">● 卫生间</div>
                    ...
                    <div class="rq-hint">暗卫无窗，需强化排风和照明。干湿分离后放置：2台Catlink电动猫砂盆（单机600×580×710mm）、独立洗衣机+烘干机+小内衣洗衣机、扫地机器人基站（自动上下水+插座）。</div>
                </div>
