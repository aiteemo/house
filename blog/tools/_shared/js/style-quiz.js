...
class StyleQuizManager {
    ...
    saveState() {
        ...
        localStorage.setItem('aiteemo_style_quiz_demo_v1', JSON.stringify(data));
    }

    loadState() {
        const raw = localStorage.getItem('aiteemo_style_quiz_demo_v1');
        if (!raw) return;
        try {
    ...
    clearState() {
        localStorage.removeItem('aiteemo_style_quiz_demo_v1');
    }
